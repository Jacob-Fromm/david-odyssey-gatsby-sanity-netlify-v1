# david-odyssey-gatsby-sanity-netlify-v1
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/73c1hcf3/settings/api) and create a token with read rights.
